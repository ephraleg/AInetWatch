...
for asset in favicon.ico favicon-32x32.png favicon-16x16.png AInetWatchTitle.png \
             Cypher1.png cypher-transparent-safari.mov cypher-transparent-final.webm; do
  src="$REPO_ROOT/$asset"
  if [ ! -f "$src" ]; then
